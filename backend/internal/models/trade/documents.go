...
type ShipmentTracking struct {
	...
	Status           string     `gorm:"type:varchar(50);default:'PENDING'" json:"status"` // PENDING, DISPATCHED, IN_TRANSIT, DELIVERED, EXCEPTION
	DeliveredAt      *time.Time `json:"deliveredAt,omitempty"`
	DeliveryProofURL    string                  `gorm:"type:varchar(500)" json:"deliveryProofUrl,omitempty"`
	CustomerAttachments modelsCommon.StringArray `gorm:"type:jsonb" json:"customerAttachments,omitempty"`
