	...
	categories := []modelsProduct.Category{
		{
			...
			Thumbnail:   "/images/hero-candy.jpg",
			Icon:        "gummy",
			CreatedAt:   time.Now(),
			UpdatedAt:   time.Now(),
		},
	...
	products := []modelsProduct.Product{
		{
			...
			Thumbnail:      "/images/hero-candy.jpg",
			Images:         modelsCommon.StringArray{"/images/hero-candy.jpg", "/images/factory-1.jpg"},
			OEMAvailable:   true,
			HalalCertified: true,
		...
		},
		{
			...
			Thumbnail:      "/images/hero-candy.jpg",
			Images:         modelsCommon.StringArray{"/images/hero-candy.jpg", "/images/factory-2.jpg"},
			OEMAvailable:   true,
			HalalCertified: true,
		...
		},
		{
			...
			Thumbnail:      "/images/hero-candy.jpg",
			Images:         modelsCommon.StringArray{"/images/hero-candy.jpg"},
			OEMAvailable:   true,
			HalalCertified: true,
