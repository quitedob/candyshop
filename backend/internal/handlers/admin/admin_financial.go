...
func (h *Handler) GetFinancialOverview(c *gin.Context) {
	...
	if err != nil {
		utils.ErrorResp(c, http.StatusInternalServerError, "overdue_fetch_failed")
		return
	}
	...
	if err != nil {
		utils.ErrorResp(c, http.StatusInternalServerError, "payment_count_fetch_failed")
		return
	}
	...
	if err != nil {
		utils.ErrorResp(c, http.StatusInternalServerError, "revenue_fetch_failed")
		return
	}
...
func (h *Handler) GetOutstandingInvoices(c *gin.Context) {
	...
	if err != nil {
		utils.ErrorResp(c, http.StatusInternalServerError, "outstanding_invoices_fetch_failed")
		return
	}
...
func (h *Handler) GetPaymentBreakdown(c *gin.Context) {
	...
	if err != nil {
		utils.ErrorResp(c, http.StatusInternalServerError, "payment_breakdown_fetch_failed")
		return
	}
